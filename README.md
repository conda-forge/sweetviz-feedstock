...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sweetviz-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11797&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sweetviz-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sweetviz` can be installed with:

```
conda install sweetviz
```

It is possible to list all of the versions of `sweetviz` available on your platform with:
